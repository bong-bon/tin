...
label hidden_story_7:
    ...
    menu:
        "기분이 어땠어?":
            ...
            $ change_image('say_2')
            T "그래도, 이런 나, 나라도 살인이 나쁘다는 건 알아."
            T "왜냐하면... 무언가를 해하는 게, 특히 나와 같은 인간을 해친다는 건, 그건 {i}인간적{/i}이지 않은 거야."
            $ change_image('base_2')
            T "이, 인간성이 없다는 건 두려, 두려운 일이야. 우, 우린 동족을 해치면 안돼."
            T "인간은 사회적인, 동물이야. 우리의 처음부터 가, 각인된 {i}본질{/i}이 없다면... 버려질 수밖에 없어. 함께할 수 없으니까."
            T "내가, 아, 하고 싶은 말이 뭐냐면. 아니, 아니야. 지금까지의 말은 아니야."
            # 와앙 입 벌린 표정?
            T "사람을 죽이고 싶지 않아. 이런 건, 이런 건 짐승이야. 짐승은 그, 그분을 섬길 수 없어."
            T "나도 괴로워. 나, 나도, 더는 싫어. 익숙해지고, 싶지 않아. 까, 깎여가는 내 인간성이 두려워... 나도, 나도 사람이고 싶어..."
